#!/bin/bash
#FileName : BmcCtrlLEDs.sh
#Author   : CodyQin, qiutiqin@msi.com
#----Define sub function---------------------------------------------------------------------
VersionInfo()
{
	ApVersion="1.0.0"
	local CreatedDate="2020-08-24"
	local UpdatedDate="2020-08-24"
	local Description="Turn on/off LEDs by command 'ipmitool' and check the on/off LEDs' amount"
	...
	if [ "${CountingStatus}" == "off" ] ; then
		...
		do
			...
			do
				...
				bit2Bin=$(echo "000000000000000000000000000000000000${bit2Bin}")
		...
		do
			Error=0
			#CheckList: 點亮數量;點亮位置,如11;010111100011000011010001(如下則轉為16進制)
