...
def config_format():
    ...
    <TestCase>
        ...
        <portlist>
            <port bus="c0" sata_list="00000000" nvme_list="11111111" strap_register="fc 21 07" mg9200_fw= "00 00 3c f0 23 02 b0 17" fru_fw="01 03" e6_register="ff" GPIO_VPP_status="00 00 0f f0 3f" cfru_checksum="45 c9 16 b9"/>
